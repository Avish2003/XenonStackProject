                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="furnitures.jsp">Furnitures</a>
                              </li>
                              <li class="nav-item">
                              ...
                              <li class="nav-item d_none">
                                 <a class="nav-link" href="SignUp.jsp"><i class="fa fa-user-circle padd_right" aria-hidden="true"></i>Login/Register</a>
                              </li>
                              <li class="nav-item d_none">
